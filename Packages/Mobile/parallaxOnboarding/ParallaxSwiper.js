...
class ParallaxSwiper extends Component {
  ...
  onScrollEnd(e) {
    ...
    this.setState({pageIndex: Math.abs((contentOffset / viewSize).toFixed()) || 0});
    onMomentumScrollEnd(this.state.pageIndex);
  }
    ...
    return (
      <View pointerEvents="box-none">
        <View style={styles.buttonStyle}>
          <View style={this.state.pageIndex == 0 ? styles.dot : styles.dotUno} />
          <View style={this.state.pageIndex == 1 ? styles.dot : styles.dotUno} />
          <View style={this.state.pageIndex == 2 ? styles.dot : styles.dotUno} />
        </View>
        <Animated.ScrollView
          ref={(scrollView) => {
